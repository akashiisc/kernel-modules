...
#define PAGE_MAP_STATS_FAST _IOWR('a' , 'b' , uint32_t*)
...
static int __init etx_driver_init(void)
{
	...
	if((dev_class = class_create(THIS_MODULE,"etx_class_fast")) == NULL){
		printk(KERN_INFO "Cannot create the struct class\n");
		goto r_class;
	}

	/*Creating device*/
	if((device_create(dev_class,NULL,dev,NULL,"page_map_stats_fast_device")) == NULL){
